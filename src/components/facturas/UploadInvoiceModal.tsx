  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#111] w-full max-w-lg rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-800 flex flex-col">
        ...
        <div className="p-6">
          {error && (
            <div className="mb-4 p-3 bg-red-50 text-red-600 rounded-xl text-sm border border-red-200 animate-in slide-in-from-top-2">
              {error}
            </div>
          )}
            ...
            >
              ...
              {file ? (
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white truncate max-w-[200px] mx-auto">
                      {file.name}
                    </p>
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="font-semibold text-gray-900 dark:text-white">
                    Arrastra tu factura en PDF aquí
                  </p>
