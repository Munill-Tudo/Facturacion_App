...
export function EditarMovimientoModal({ movimiento, onClose, onSaved }: { movimiento: any | null; onClose: () => void; onSaved: () => void; }) {
  ...
  useEffect(() => {
    ...
    setFechaDudosa(parseBool(movimiento.fecha_dudosa));
    setError(null);
  }, [movimiento]);
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 p-3 sm:p-4">
      <div className="flex min-h-full items-start justify-center py-4 sm:items-center sm:py-8">
        <div className="w-full max-w-2xl rounded-3xl border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-[#0a0a0a] max-h-[92vh] overflow-hidden">
          <div className="flex items-center justify-between border-b border-gray-100 px-4 py-4 sm:px-6 dark:border-gray-800">
            <div>
          ...
          <div className="max-h-[calc(92vh-140px)] overflow-y-auto px-4 py-5 sm:px-6">
          ...
          <div className="flex items-center justify-end gap-3 border-t border-gray-100 px-4 py-4 sm:px-6 dark:border-gray-800">
